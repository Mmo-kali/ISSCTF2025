...
def index():
    ...
    if auth_cookie == 'c2hhZG93TWFuOnBhc3N3b3Jk':
        return render_template('index2.html', user=tokens.get(auth_cookie, 'Unknown User'))
    
    elif auth_cookie == 'This-is-not-The-SOulition':  # in case they brute force
        return render_template('index2.html', user=tokens.get(auth_cookie, 'Unknown User'))
